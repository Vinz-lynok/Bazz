...
def banner():
	os.system('clear')
	baz_bann(f'''{biru}welcome to the bazz script gunakan dengan bijak
{biru}    ____  ___ __________
{biru}   / __ )/   /__  /__  /
{biru}  / __  / /| | / /  / / 
{biru} / /_/ / ___ |/ /__/ /__
{biru}/_____/_/  |_/____/____/
B A Z Z X D''')
...
def menu(id):
	...
	banner()
	print(f'{xxx}─────────────────────────────')
	print(f'{xxx}└── ketik bazz Y untuk mulai crack')
	helpbas = input(f'{xxx}└── : ')
	if helpbas in ['ya','y']:
		nge_krek()
	else:
